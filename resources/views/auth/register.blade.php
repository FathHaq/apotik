...
<body>
    <style>
        ...
        * {
        ...
        .overlay {
            background: #882424;
            background: -webkit-linear-gradient(to right, #F58089, #F58089);
            background: linear-gradient(to right, #F58089, #F58089);
    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            <form method="POST" action="{{ route('login') }}">
                @csrf
                <h1>Sign in</h1>
                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Your Email, please !">
                ...
                @enderror
                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter Your Password, please !">
    ...
    <footer>
        <p>
            ...
            <a target="_blank" href="https://florin-pop.com">Dila Nur Sakinah</a>
            - DHAROSDENT
