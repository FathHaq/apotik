    ...
    <div class="container">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mt-3">Nama Jenis Produk</h5>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @include('Admin.JenisProduk.updatejp')
                    @include('Admin.JenisProduk.hapusjp')
                    @endforeach
                </tbody>
            </table>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Jenis Produk</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('jp.tambah')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="jenisproduk" class="form-label">Jenis Produk</label>
                        <input type="text" required name="jenis_produk" class="form-control" id="jenisproduk">
                    </div>
            </div>
