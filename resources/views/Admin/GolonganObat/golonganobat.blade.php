    ...
    <div class="container">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Golongan Obat</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mt-3">Nama Golongan Obat</h5>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @include('Admin.GolonganObat.hapusgo')
                    @include('Admin.GolonganObat.updatego')
                    @endforeach
                </tbody>
            </table>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Golongan Obat</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('go.tambah') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="golongan_obat" class="form-label">Golongan Obat</label>
                        <input type="text" required name="golongan_obat" class="form-control" id="golongan_obat">
                    </div>
            </div>
